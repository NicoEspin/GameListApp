        ...
        {gameList.map(
          (item, index) =>
            index < 4 && (
              ...
              hover:scale-110 transition-all duration-300 ease-in-out cursor-pointer"  key={item.id}>
                <img src={item.background_image} alt={item.name} className="h-[270px] rounded-t-lg object-cover" />
